    ...
    <div class="container-content-main header-content row" anim="fades"
        ...
        <div class="col-md-7 p-0 m-0" id="card-cover">
            <div id="cover-container" class="m-0">
                <div class="card-cover position-relative">
                    <img src="https://th.bing.com/th/id/R.3fea078f720a09d723dd7de6ac535f61?rik=EEIRT4htflWyYw&riu=http%3a%2f%2fhdqwalls.com%2fwallpapers%2fwedding-couple-on-beach-wide.jpg&ehk=QrXxBkdE5gz9GYFFd4U4Bm%2bI2lr1kTZ54%2bYtk57Z0Is%3d&risl=&pid=ImgRaw&r=0"
                        alt="" />
                    <div class="content-card position-relative">
                        <div class="gradient"></div>
                        <div class="container-bottom">
                            <input type="hidden" name="user_id" id="user_id" value="{{ $getUser->user_id }}">
                            <h3 class="header-content" anim="slide-left">{{ $mempelai ? $mempelai->namalaki : 'Adi' }} &
                                {{ $mempelai ? $mempelai->namaperempuan : 'Aci' }}</h3>
                            <p class="m-2"> {{ $afterConvertDay ? $afterConvertDay : 'Minggu' }},
                                {{ $tanggalAcara ? $tanggalAcara : '22 Juli 2014' }}</p>
                            <p class="m-2">To {{ $namaTamu ? $namaTamu : 'Tamu Undangan' }}</p>
                            <a href="" id="open-invitation">Open Invitation</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="main-content" class="col-md-5 0 m-0 p-3">
            <div class="container-fluids p-0 m-0 header-content" style="min-height: 100vh">
                ...
                "
                            anim="fades" />
                        <img src="https://th.bing.com/th/id/OIP.dxB5TdocFisKj9YdSsUYXgHaHa?pid=ImgDet&rs=1"
                            alt="" style="width: 240px; border-radius: 50%" class="mt-5" />
                    </div>
                </div>
            ...
            <div class="row header-content" style="background-color: #0000006e; height: 100px" anim="slide-down"></div>
            <div class="container-header container-fluid container-couple mb-5 mt-5 header-content" anim="slide-left">
                <div class="container text-center p-2 container-couple">
                    <img src="https://i.pinimg.com/736x/81/27/f3/8127f39490ad7dcfb567fa213d65a843.jpg" alt=""
                        class="couple-img header-content" />
                    <h3 class="mt-3">Bambang Pramono</h3>
                    <p>The Son Of Mr. Aliong and Mrs. Ratna Ayu</p>
                    <a href="" class="btn-instagram header-content" anim="slide-right"><i
                            class="fa fa-instagram mr-1 p-2"></i>Instagram</a>
                </div>
            </div>
            <div class="container-fluid container-couple header-content" anim="slide-left">
                <div class="container text-center p-2 container-couple">
                    <img src="https://images.picxy.com/cache/2021/1/12/87ad394cf071b8fdc39f8f3a307374fc.jpg"
                        alt="" class="couple-img header-content" />
                    <h3 class="mt-3">Tyas Sanjaya</h3>
                    <p>The Daughter Of Mr. Fauzi Pramana and Mrs. Bella Rahma</p>
                    <a href="" class="btn-instagram header-content" anim="slide-right"><i
                            class="fa fa-instagram mr-1 p-2"></i>Instagram</a>
                </div>
            </div>

            <div class="container-fluid container-content mt-5">
                <h3 class="header-content text-center" anim="slide-right">
                    Our Story
                </h3>
                <div class="wrapper header-content" anim="slide-right">
                    <div class="carousel">
                        <div class="image">
                            <div class="carousel-item active" data-bs-interval="2000">
                                <img src="https://cdn.pixabay.com/photo/2016/03/14/14/21/bride-1255520_150.jpg"
            ...
            <div class="container-fluid text-center mt-5 container-content header-content" anim="slide-right">
                ...
                <iframe width="100%" height="315"
                    src="https://www.youtube.com/embed/m33Dlcoqmh8?si=U1F2cuzKs7k8BXeY" title="YouTube video player"
                    frameborder="0"
            ...
            <div class="container-fluid text-center mt-5 container-content">
                ...
                <div id="gallery">
                    <img class="header-content" anim="slide-left"
                        src="https://th.bing.com/th?id=OIP.6eUuDocLITRnWyXuX9WJhAHaE8&w=306&h=204&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" />
                    <img class="header-content" anim="slide-right"
                        src="https://th.bing.com/th?id=OIP.dxB5TdocFisKj9YdSsUYXgHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" />
                    <img class="header-content" anim="slide-left"
                        src="https://th.bing.com/th?id=OIP.eWQSciE6kW7r90sH--RFkAHaEo&w=316&h=197&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" />
                    <img class="header-content" anim="slide-right"
                        src="https://th.bing.com/th?id=OIP.U2Haxp8KA3QPs1sxTZIfOAHaEK&w=333&h=187&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" />
                    <img class="header-content" anim="slide-left"
                        src="https://th.bing.com/th/id/R.a5e9bb3434a5fefb1bcd05175039abb1?rik=HjUCY5x62fQduQ&riu=http%3a%2f%2fs3-ap-south-1.amazonaws.com%2fcorpwpassets%2fblog.shaadi.com%2fprod%2fuploads%2f2017%2f02%2f31195855%2f7-650x433.jpg&ehk=%2by2vKE5e5okXSR%2fx%2bhP8mQHByIhM1ZOz%2fvMHXXVb%2bGs%3d&risl=&pid=ImgRaw&r=0" />
                    <img class="header-content" anim="slide-right"
                        src="https://i.pinimg.com/736x/8f/bf/7f/8fbf7f641afdbe38f415fe5f197a266a.jpg" />
                    <img class="header-content" anim="slide-left"
                        src="https://i.pinimg.com/736x/8f/bf/7f/8fbf7f641afdbe38f415fe5f197a266a.jpg" />
                    <img class="header-content" anim="slide-right"
                        src="https://i.pinimg.com/736x/8f/bf/7f/8fbf7f641afdbe38f415fe5f197a266a.jpg"
            ...
            <div class="container-fluid mt-5 text-center header-content">
                <h3 class="">SATURDAY</h3>
                <p>February 03rd, 2024</p>
            </div>
            ...
            <div class="container-fluid text-center mt-5 mb-5 header-content position-relative container-content">
                ...
                <div class="container mt-4">
                    <h5>JW Marriott Jakarta</h5>
                    <p class="tlp">
                        W Marriott Jkt, Kuningan, Kuningan Tim., Kecamatan Setiabudi,
                        Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta, Indonesia
                        Kota Jakarta Selatan
                    </p>
                    <a href="" class="primary-btn mb-5">View Map</a>
                </div>
            </div>
            <div class="container-fluid text-center mt-5 mb-5 header-content position-relative container-content"
                anim="slide-right">
                ...
                <div class="container mt-4">
                    ...
                    <a href="" class="primary-btn">View Map</a>
                </div>
            </div>
            ...
            <div class="container-fluid container-content text-center" style="margin-top: 200px">
                ...
                <iframe class="header-content" width="400" height="315"
                    src="https://www.youtube.com/embed/M5Byww-rz-Y?si=r_3QyOykFlldZJ8l" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
            ...
            <div class="container-fluid header-content text-center container-content" style="margin-top: 50px">
                ...
                <div class="container-fluid text-start">
                    ...
                    <div class="container-fluid mt-3 bank-bca">
                        ...
                        <p class="mt-1">
                            Account Number <br />
                            <span id="no-rek"><b>8321242123</b></span> <a href="#" class="copy-button"><i
                                    class="fa fa-copy"></i></a>
                        </p>
                        <p>
                            Account Name <br />
                            Muhammad Fanny Al farizzy
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid mt-5 header-content container-content p-4 text-start" anim="slide-up">
                ...
                <textarea name="" id="" cols="30" rows="" class="form-control mb-4"
                    placeholder="Give you wish"></textarea>
                <a class="primary-btn mt-2">Send</a>
                <div class="container mt-5 text-start" style="font-size: 8pt">
                    <div class="row">
                        <div class="col-2 p-0">
                            <img style="aspect-ratio: 1/1;  object-fit:cover;width:  100%;border-radius: 50%;"
            ...
            <div class="container text-center mt-5 header-content container-content" anim="slide-up">
                <p>Two souls become one heart</p>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateCountdown() {
                const targetDate = new Date("2024-09-26 18:24:00").getTime(); // Change this to your target date
